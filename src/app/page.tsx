        ...
        <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <a href="https://github.com/nodetec/comet/releases/latest" className="inline-flex space-x-6">
              ...
              <span className="inline-flex items-center space-x-2 text-sm/6 font-medium text-gray-300">
                <span>Just shipped v0.8.0-alpha</span>
                <ChevronRightIcon
                  aria-hidden="true"
          ...
          <div className="mt-10">
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
              <a
                href="https://github.com/nodetec/comet/releases/download/v0.8.0-alpha/Comet-v0.8.0-alpha-Darwin-arm64.dmg"
              ...
              <a
                href="https://github.com/nodetec/comet/releases/download/v0.8.0-alpha/Comet-v0.8.0-alpha-amd64.AppImage"
                className="text-center rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
              >
                Linux AppImage
              </a>
              <a
                href="https://github.com/nodetec/comet/releases/download/v0.8.0-alpha/Comet-v0.8.0-amd64.deb"
                className="text-center rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
              >
                Linux .deb
              </a>
              <a
                href="https://github.com/nodetec/comet/releases/download/v0.8.0-alpha/Comet-v0.8.0-alpha-amd64.rpm"
                className="text-center rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
              >
                Linux .rpm
              </a>
